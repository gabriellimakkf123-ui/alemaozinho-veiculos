/* ==========================================================================
   ALEMÃOZINHO VEÍCULOS - JAVASCRIPT PUBLIC SHOWROOM LOGIC
   ========================================================================== */
...
function changeHeroBg(type) {
  ...
  const btnStorefront = document.getElementById('btnBgStorefront');
  const btnRender = document.getElementById('btnBgRender');
  const btnCar = document.getElementById('btnBgCar');

  if (!hero) return;

  hero.classList.remove('facade-render-bg', 'car-bg');
  [btnStorefront, btnRender, btnCar].forEach(b => b && b.classList.remove('active'));
  ...
  if (type === 'render') {
    ...
    // Default storefront
    if (btnStorefront) btnStorefront.classList.add('active');
  }
}
